...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // J'aimerais pouvoir utiliser une onde sinusoidale pour changer ça
        // C'est quoi les valeurs que translate peut avoir?
        view  = glm::translate(view, glm::vec3(xCamera, yCamera, -3.0f));
